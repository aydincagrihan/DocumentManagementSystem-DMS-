...
namespace DocumentManagementSystem.Data.Migrations
{
    ...
    [Migration("20210101180311_studentInfo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocumentManagementSystem.Core.Entities.StudenInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DocumentManagementSystem.Core.Entities.StudenInfo", b =>
                {
                    ...
                    b.HasOne("DocumentManagementSystem.Core.Entities.Programs", null)
                        .WithMany("StudenInfo")
                        .HasForeignKey("ProgramsId");
                    ...
                    b.HasOne("DocumentManagementSystem.Core.Entities.User", "User")
                        .WithOne("StudenInfo")
                        .HasForeignKey("DocumentManagementSystem.Core.Entities.StudenInfo", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DocumentManagementSystem.Core.Entities.UserType", null)
                        .WithMany("StudenInfo")
